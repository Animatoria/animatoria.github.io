...
function getStoredCards() {
  var notAnyCardShowedSwitch = true
  ...
  if (notAnyCardShowedSwitch && (currentDateToLocaleDateString != mainDate && confirm('This ' + mainDate + ' card list empty. Delete?'))) {
